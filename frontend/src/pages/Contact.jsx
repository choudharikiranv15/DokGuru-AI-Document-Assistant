                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-8 sm:mb-12">
                        ...
                        <motion.a
                            ...
                            className="group p-5 sm:p-8 bg-gradient-to-br from-cyan-500/10 to-cyan-500/5 border border-cyan-500/20 hover:border-cyan-500/40 rounded-xl sm:rounded-2xl transition-all hover:scale-105"
                        >
                            <div className="flex items-start gap-3 sm:gap-4">
                                <div className="p-2 sm:p-3 bg-cyan-500/20 rounded-lg sm:rounded-xl group-hover:bg-cyan-500/30 transition-colors flex-shrink-0">
                                ...
                                <div>
                                    <h3 className="text-lg sm:text-xl font-semibold text-white mb-1 sm:mb-2">Email Us</h3>
                                    <p className="text-gray-400 text-xs sm:text-sm mb-2 sm:mb-3">
                                        General inquiries, support, or feedback
                                    </p>
                                    <p className="text-cyan-400 group-hover:text-cyan-300 font-medium text-sm sm:text-base">
                                        contact@dokguru.com
                                    </p>
                                </div>
                            </div>
                        ...
                        <motion.a
                            ...
                            className="group p-5 sm:p-8 bg-gradient-to-br from-purple-500/10 to-purple-500/5 border border-purple-500/20 hover:border-purple-500/40 rounded-xl sm:rounded-2xl transition-all hover:scale-105"
                        >
                            <div className="flex items-start gap-3 sm:gap-4">
                                <div className="p-2 sm:p-3 bg-purple-500/20 rounded-lg sm:rounded-xl group-hover:bg-purple-500/30 transition-colors flex-shrink-0">
                                    <svg className="w-5 h-5 sm:w-7 sm:h-7 text-purple-400" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <div>
                                    <h3 className="text-lg sm:text-xl font-semibold text-white mb-1 sm:mb-2">Report a Bug</h3>
                                    <p className="text-gray-400 text-xs sm:text-sm mb-2 sm:mb-3">
                                        Found a bug or have a feature request?
                                    </p>
                                    <p className="text-purple-400 group-hover:text-purple-300 font-medium text-sm sm:text-base">
                                        Open GitHub Issue →
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8">
                        <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Quick Questions?</h2>
                        <div className="space-y-3 sm:space-y-4">
                            <div className="p-3 sm:p-4 bg-white/5 rounded-lg">
                                <h3 className="font-semibold text-white text-sm sm:text-base mb-1 sm:mb-2">How long does it take to get a response?</h3>
                                <p className="text-gray-400 text-xs sm:text-sm">
                                    We typically respond to emails within 24-48 hours. For urgent bugs, please use GitHub Issues for faster response.
                                </p>
                            </div>
                            <div className="p-3 sm:p-4 bg-white/5 rounded-lg">
                                <h3 className="font-semibold text-white text-sm sm:text-base mb-1 sm:mb-2">Can I contribute to DokGuru?</h3>
                                <p className="text-gray-400 text-xs sm:text-sm">
                            ...
                            <div className="p-3 sm:p-4 bg-white/5 rounded-lg">
                                <h3 className="font-semibold text-white text-sm sm:text-base mb-1 sm:mb-2">Need technical support?</h3>
                                <p className="text-gray-400 text-xs sm:text-sm">
